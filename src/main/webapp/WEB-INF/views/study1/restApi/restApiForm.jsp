...
<div class="container">
	...
	<hr/>
		...
		<a href="${ctp}/study1/restApi/test2/Hello springFramework2" class="btn btn-success me-3">호출2(o)</a>
		<a href="${ctp}/restApi/restApi1/Hello springFramework3" class="btn btn-success me-3">호출3(RestController-문자)</a>
		<a href="${ctp}/restApi/restApi2/Hello springFramework4" class="btn btn-success me-3">호출4(RestController-객체)</a>
	<hr/>
	<pre>
