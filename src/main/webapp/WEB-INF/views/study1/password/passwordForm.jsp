...
<div class="container">
	...
	<div>
		<input type="button" value="SHA256" onclick="sha256Check()" class="btn btn-warning"/>
		<input type="button" value="ARIA" onclick="ariaCheck()" class="btn btn-warning"/>
		<input type="button" value="BCryptPasswordEncoder" onclick="bcCheck()" class="btn btn-warning"/>
	</div>
	출력결과 :<br/>
	<div id="demo"></div>
</div>
