...
insert into guest values (default, '관리자', '방명록 서비스를 시작합니다.', 'cjsk1126@naver.com', 'cjsk1126.tistory.com', default, '192.168.50.61');
insert into guest values (default, '민우리', '반가워.', 'gggg@naver.com', 'gggg.tistory.com', default, '192.168.50.61');
