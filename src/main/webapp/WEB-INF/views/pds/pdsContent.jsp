...
<head>
	...
	function deleteCheck() {
		let ans = comfirm("선택하신 자료를 삭제하시겠습니까?");
		if(!ans) return false;
		$.ajax({
...
<div class="container">
	...
	<table class="table table-bordered text-center">
		...
		<tr>
			<th>파일명</th>
			<td>
				<c:set var="fNames" value="${fn:split(vo.FName,'/')}" />   <!-- a.jpg/b.jpg/c.gif -->
	...
	<div class="row">
		<div class="col text-start"><a href="pdsList?&pag=${pageVO.pag}&pageSize=${pageVO.pageSize}&part=${vo.part}" class="btn btn-success">돌아가기</a></div>
		<c:if test="${vo.mid == sMid || sLevel == 0}">
			<div class="col text-end">
				<c:if test="${vo.mid == sMid || sLever != 0}">
